...
@tbl-avgresponses summarizes the average of responses per year for each variable.
...
## Average change of importance
In @tbl-avgchange, all columns show a general increase in values, while the Social Usefulness column is the only column that consistently conveys an increase.

```{r}
#| label: tbl-avgchange
#| tbl-cap: The average change for very important and important responses for helping others 
#| echo: false
#| warning: false
