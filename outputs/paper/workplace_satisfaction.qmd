...
In @fig-avgchange, all columns show a general increase in values, while the Social Usefulness column is the only column that consistently conveys an increase.

```{r}
#| label: fig-avgchange
#| fig-cap: avg change for very important and important responses for helping others 
#| echo: false
#| warning: false
