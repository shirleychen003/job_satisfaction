...
@tbl-gender shows the number and percentage of male and female respondents for 1989, 1998, 2006, and 2016. @tbl-age shows the mean, median, mode, min, and max of respondent age for all four years of data collection.  
...
```{r}
#| label: tbl-age-groups
#| echo: false
#| warning: false
#| tbl-cap: Respondent Age Groups by Year
